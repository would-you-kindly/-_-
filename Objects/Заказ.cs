...
namespace IIS.АСУ_Склад
{
    ...
    public class Заказ : IIS.АСУ_Склад.Документ
    {
        ...
        /// Заказ.
        /// </summary>
        // *** Start programmer edit section *** (Заказ.Накладная CustomAttributes)

        // *** End programmer edit section *** (Заказ.Накладная CustomAttributes)
        ...
        public virtual IIS.АСУ_Склад.Накладная Накладная
        {
            get
            {
                // *** Start programmer edit section *** (Заказ.Накладная Get start)

                // *** End programmer edit section *** (Заказ.Накладная Get start)
                IIS.АСУ_Склад.Накладная result = this.fНакладная;
                // *** Start programmer edit section *** (Заказ.Накладная Get end)

                // *** End programmer edit section *** (Заказ.Накладная Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Заказ.Накладная Set start)

                // *** End programmer edit section *** (Заказ.Накладная Set start)
                this.fНакладная = value;
                // *** Start programmer edit section *** (Заказ.Накладная Set end)

                // *** End programmer edit section *** (Заказ.Накладная Set end)
            }
        }

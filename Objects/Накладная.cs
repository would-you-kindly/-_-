...
namespace IIS.АСУ_Склад
{
    ...
    [AssociatedDetailViewAttribute("НакладнаяE", "ЗаказВНакладной", "ЗаказВНакладнойE", true, "", "Заказ в накладной", true, new string[] {
            ""})]
    ...
    public class Накладная : IIS.АСУ_Склад.Документ
    {
        ...
        private IIS.АСУ_Склад.DetailArrayOfЗаказВНакладной fЗаказВНакладной;
        ...
        /// Накладная.
        /// </summary>
        // *** Start programmer edit section *** (Накладная.ЗаказВНакладной CustomAttributes)

        // *** End programmer edit section *** (Накладная.ЗаказВНакладной CustomAttributes)
        public virtual IIS.АСУ_Склад.DetailArrayOfЗаказВНакладной ЗаказВНакладной
        {
            get
            {
                // *** Start programmer edit section *** (Накладная.ЗаказВНакладной Get start)

                // *** End programmer edit section *** (Накладная.ЗаказВНакладной Get start)
                if ((this.fЗаказВНакладной == null))
                {
                    this.fЗаказВНакладной = new IIS.АСУ_Склад.DetailArrayOfЗаказВНакладной(this);
                }
                IIS.АСУ_Склад.DetailArrayOfЗаказВНакладной result = this.fЗаказВНакладной;
                // *** Start programmer edit section *** (Накладная.ЗаказВНакладной Get end)

                // *** End programmer edit section *** (Накладная.ЗаказВНакладной Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Накладная.ЗаказВНакладной Set start)

                // *** End programmer edit section *** (Накладная.ЗаказВНакладной Set start)
                this.fЗаказВНакладной = value;
                // *** Start programmer edit section *** (Накладная.ЗаказВНакладной Set end)

                // *** End programmer edit section *** (Накладная.ЗаказВНакладной Set end)
            }
        }
